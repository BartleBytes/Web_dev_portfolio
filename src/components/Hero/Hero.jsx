...
export const Hero = () => {
    ...
    <section className={styles.container}>
        <div className={styles.content}> 
            ...
            <p className={styles.description}>Software engineer with a background in economics & finance. 3+ years of experience in Java, JavaScript and Python Reach out if you&apos;d like to learn more!</p>
